            ...
            return (
              <div className="acc-item" key={index}>
                ...
                >
                  ...
                  <span>
                    Order Date: {moment(order.createdAt).format("Do MMM, YY")}
                  </span>
                  <i
                    className={
                      selected === index
                ...
                >
                  <span className="d-none d-md-block">{getStatus()}</span>
                  <span>
                    <label className="text-muted font-weight-bold mt-3 ml-3">
