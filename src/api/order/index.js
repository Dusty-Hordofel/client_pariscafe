...
export const getOrdersForAdmin = async (token, status = "Ordered") => {
  ...
  try {
    ...
    console.log("🚀 ~ file: index.js ~ line 45 ~ getOrdersForAdmin ~ error", error)
...
export const updateOrderStatus = async (id, status, token) => {
  ...
  try {
    ...
    const result = await AxiosInstance.put(`${URI}`, { new_status: status }, { headers })

    return result;

  } catch (error) {

    console.log("🚀 ~ file: index.js ~ line 79 ~ updateOrderStatus ~ error", error)
...
export const cancelOrder = async (id, status, token) => {
  ...
  console.log("🚀 ~ file: index.js ~ line 125 ~ cancelOrder ~ headers", headers)
  ...
  try {
    ...
    const result = await AxiosInstance.delete(`${URI}`, { data: { new_status: status }, headers });
...
export const getOrderStatus = async (id) => {
  ...
  try {
    ...
    console.log("🚀 ~ file: index.js ~ line 159 ~ getOrderStatus ~ error", error);
    throw error;
